...
unsigned int nStakeMinAge       = 30 * 24 * 60 * 60;      // 8 hour min stake age
...
const string strMessageMagic = "JBChain Signed Message:\n";
...
/* 	if (pindexBest->nHeight > (YEARLY_BLOCKCOUNT*37)) // 37 years.
    ...
    if (pindexBest->nHeight <= (20 * YEARLY_BLOCKCOUNT)) // After 20 years, 0% PoS
        nRewardCoinYear = 4 * COIN_YEAR_REWARD; 
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JBChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "JBChain";
        CTransaction txNew;
        txNew.nTime = 1534223755;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x195cdca79b6f0de85b60026a4ba9b3535fe6902bd2847cad1ede3c9ef60432e2"));
        block.print();
