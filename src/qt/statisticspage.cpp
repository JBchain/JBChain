...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"lightgreen\">" + qVolume + " JBC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"lightred\">" + qVolume + " JBC" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"lightblue\">" + qVolume + " JBC" + "</font></b>");
    }
